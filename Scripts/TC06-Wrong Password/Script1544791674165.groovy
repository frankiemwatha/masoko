...
WebUI.click(findTestObject('Invalid Log In/Page_Shop Online in Kenya - Pay Con/p_Sign In'))

WebUI.setText(findTestObject('Invalid Log In/Page_Customer Login/input_loginusername'), 'mwathambugua@gmail.com')
